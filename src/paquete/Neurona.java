...
public class Neurona {
	...
	// En este metodo Hacemos los calculos basicos de las entradas con sus pesos y
	// entradas a la neurona y umbral
	...
	// Realizamos la funcion sigmoide con los datos del metodo anterior, e
	// introduciendo los en el array de salida
	public void sigmoide() {
		float f = 0;

		if (capa == 0) {
			f = this.calculoXCapasIniciales();
		} else {
	...
	public String toString() {
		return "Neurona [umbral=" + umbral + ", entradas=" + Arrays.toString(entradas) + ", pesos="
				+ Arrays.toString(pesos) + ", salidas=" + Arrays.toString(salidas) + ", capa=" + capa
				+ ", pesosAntiguos=" + Arrays.toString(pesosAntiguos) + "]";
	}
